...
function isToken(obj) {
  if (isObject(obj) &&
      obj.scopes && Array.isArray(obj.scopes) &&
      (obj.expiresAt || obj.expiresAt === 0) &&
      (obj.idToken || obj.accessToken) &&
      obj.issuer) {
    return true;
  }
  return false;
...
var isTokenErrorMessage = 'Token must be an Object with scopes, idToken or ' +
  'accessToken, expiresAt, and issuer properties';
...
module.exports = {
  ...
  isToken: isToken,
  isTokenErrorMessage: isTokenErrorMessage
};
