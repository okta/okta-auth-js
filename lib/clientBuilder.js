...
function OktaAuthBuilder(args) {
  ...
  sdk.idToken = {
    authorize: util.deprecateWrap('Use token.getWithoutPrompt, token.getWithPopup, or token.getWithRedirect ' +
      'instead of idToken.authorize.', util.bind(token.getToken, sdk, sdk), sdk),
    verify: util.deprecateWrap('Use token.verify instead of idToken.verify',
      util.bind(token.verifyIdToken, sdk, sdk), sdk),
    refresh: util.deprecateWrap('Use token.refresh instead of idToken.refresh',
      util.bind(token.refreshIdToken, sdk, sdk), sdk),
    decode: util.deprecateWrap('Use token.decode instead of idToken.decode',
      util.bind(token.decodeToken, sdk), sdk)
  };
