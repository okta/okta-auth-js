...
import { IdxTransactionManagerInterface, OktaAuthIdxInterfaceBase, OktaAuthIdxConstructor } from '../types/api';
...
: OktaAuthIdxConstructor<
  OktaAuthIdxInterfaceBase<M, S, O, TM> & OktaAuthBaseOAuthInterface<M, S, O, TM>
>
{
