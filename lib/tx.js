...
function transactionStep(sdk, args) {
  args = addStateToken(sdk, args);
  var apiUrl = '/api/v2/authn/';
  if (args.introspect) {
    return http.post(sdk, sdk.options.url + '/api/v1/idx/introspect', args);
  } else {
    return http.post(sdk, sdk.options.url + apiUrl, args);
  }
}
