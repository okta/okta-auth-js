...
function OktaAuth(args) {
  ...
  sdk.session = {
    close: util.bind(closeSession, sdk, sdk),
    exists: util.bind(sessionExists, sdk, sdk),
    get: util.bind(getSession, sdk, sdk),
    refresh: util.bind(refreshSession, sdk, sdk),
    setCookieAndRedirect: util.bind(setCookieAndRedirect, sdk, sdk)
  };
