...
var storageUtil = require('./serverStorageUtil');
var Q = require('q');
...
function httpRequest(sdk, options) {
  ...
  var err, res;
  return new Q(sdk.options.request(method, url, ajaxOptions))
    .then(function(resp) {
      res = resp.responseText || resp;
    ...
    .fail(function(resp) {
      var serverErr = resp.responseText || resp || {};
