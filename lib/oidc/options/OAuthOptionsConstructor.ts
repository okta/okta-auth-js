...
import { HttpOptionsConstructor } from '../../http/options';
import {
  OAuthResponseMode,
  OAuthResponseType,
...
export class OAuthOptionsConstructor
<
  M extends OAuthTransactionMeta,
  S extends OAuthStorageManagerInterface<M>
>
extends HttpOptionsConstructor implements Required<OktaAuthOAuthOptions<M, S>>
{
  // CustomUrls
  issuer: string;
  authorizeUrl: string;
