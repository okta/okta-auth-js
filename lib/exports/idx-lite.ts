...
import { createOktaAuthIdxLite } from '../idx/factory/OktaAuthIdxLite';
...
const OktaAuthIdx = createOktaAuthIdxLite(StorageManager, OptionsConstructor, TransactionManager);
