...
- [Okta Auth JavaScript SDK](#okta-auth-javascript-sdk)
  - [Release Status](#release-status)
  - [Need help?](#need-help)
    - [Browser compatibility / polyfill](#browser-compatibility--polyfill)
    - [Third party cookies](#third-party-cookies)
  - [Getting started](#getting-started)
    - [Creating your Okta application](#creating-your-okta-application)
    - [Configuring your Okta application](#configuring-your-okta-application)
      - [Client ID](#client-id)
      - [Login redirect URIs](#login-redirect-uris)
      - [Logout redirect URIs](#logout-redirect-uris)
    - [Using the npm module](#using-the-npm-module)
  - [Usage guide](#usage-guide)
    - [Usage with Typescript](#usage-with-typescript)
  - [Strategies for Obtaining Tokens](#strategies-for-obtaining-tokens)
    - [Redirect to Okta](#redirect-to-okta)
      - [Handling the callback without routing](#handling-the-callback-without-routing)
      - [Handling the callback with hash routing](#handling-the-callback-with-hash-routing)
      - [Handling the callback with path routing (on a dedicated route)](#handling-the-callback-with-path-routing-on-a-dedicated-route)
  - [Configuration reference](#configuration-reference)
    - [About the Issuer](#about-the-issuer)
    - [Configuration options](#configuration-options)
      - [The `tokenManager`](#the-tokenmanager)
        - [Storage](#storage)
      ...
      - [Authorization Code flow for web and native client types](#authorization-code-flow-for-web-and-native-client-types)
      - [PKCE OAuth 2.0 flow](#pkce-oauth-20-flow)
      - [Implicit OAuth 2.0 flow](#implicit-oauth-20-flow)
    - [Optional configuration options](#optional-configuration-options)
    - [`httpRequestClient`](#httprequestclient)
  - [API Reference](#api-reference)
    - [`signIn(options)`](#signinoptions)
    - [`signInWithCredentials(options)`](#signinwithcredentialsoptions)
    - [`signInWithRedirect(options)`](#signinwithredirectoptions)
    - [`signOut()`](#signout)
    - [`closeSession()`](#closesession)
    - [`revokeAccessToken(accessToken)`](#revokeaccesstokenaccesstoken)
    - [`revokeRefreshToken(refreshToken)`](#revokerefreshtokenrefreshtoken)
    ...
    - [`webfinger(options)`](#webfingeroptions)
    - [`fingerprint(options)`](#fingerprintoptions)
    - [`isAuthenticated(timeout?)`](#isauthenticatedtimeout)
    - [`getUser()`](#getuser)
    - [`getIdToken()`](#getidtoken)
    - [`getAccessToken()`](#getaccesstoken)
    - [`storeTokensFromRedirect()`](#storetokensfromredirect)
    - [`setOriginalUri(uri?)`](#setoriginaluriuri)
    - [`getOriginalUri()`](#getoriginaluri)
    - [`removeOriginalUri()`](#removeoriginaluri)
      - [`isLoginRedirect()`](#isloginredirect)
    - [`handleLoginRedirect(tokens?)`](#handleloginredirecttokens)
    - [`tx.resume()`](#txresume)
    - [`tx.exists()`](#txexists)
    ...
    - [`token`](#token)
      - [Authorize options](#authorize-options)
        - [Example](#example)
      - [`token.getWithoutPrompt(options)`](#tokengetwithoutpromptoptions)
      - [`token.getWithPopup(options)`](#tokengetwithpopupoptions)
      - [`token.getWithRedirect(options)`](#tokengetwithredirectoptions)
      - [`token.parseFromUrl(options)`](#tokenparsefromurloptions)
      - [`token.decode(idTokenString)`](#tokendecodeidtokenstring)
      - [`token.renew(tokenToRenew)`](#tokenrenewtokentorenew)
      - [`token.getUserInfo(accessTokenObject, idTokenObject)`](#tokengetuserinfoaccesstokenobject-idtokenobject)
      - [`token.verify(idTokenObject)`](#tokenverifyidtokenobject)
    ...
    - [`tokenManager`](#tokenmanager-1)
      - [`tokenManager.add(key, token)`](#tokenmanageraddkey-token)
      - [`tokenManager.get(key)`](#tokenmanagergetkey)
      - [`tokenManager.getTokens()`](#tokenmanagergettokens)
      - [`tokenManager.setTokens(tokens)`](#tokenmanagersettokenstokens)
      - [`tokenManager.hasExpired(token)`](#tokenmanagerhasexpiredtoken)
      - [`tokenManager.remove(key)`](#tokenmanagerremovekey)
      - [`tokenManager.clear()`](#tokenmanagerclear)
      - [`tokenManager.renew(key)`](#tokenmanagerrenewkey)
      - [`tokenManager.on(event, callback[, context])`](#tokenmanageronevent-callback-context)
      - [`tokenManager.off(event[, callback])`](#tokenmanageroffevent-callback)
    - [`authStateManager`](#authstatemanager)
      ...
      - [`authStateManager.subscribe(handler)`](#authstatemanagersubscribehandler)
      - [`authStateManager.unsubscribe(handler?)`](#authstatemanagerunsubscribehandler)
  - [Node JS and React Native Usage](#node-js-and-react-native-usage)
    - [Configuration](#configuration)
    - [Supported APIs](#supported-apis)
  - [Building the SDK](#building-the-sdk)
  - [Linking the built SDK locally](#linking-the-built-sdk-locally)
