...
if [[ "${BACON_TASK}" == true ]]; then
  ...
  export WEB_CLIENT_ID=0oav2oxnlYjULp0Cy5d6
  get_vault_secret_key devex/prod-js-idx-sdk-vars prod_client_secret WEB_CLIENT_SECRET
  ...
  # get_vault_secret_key devex/trex-js-idx-sdk-vars trex_mfa_client_id MFA_CLIENT_ID
  # get_vault_secret_key devex/trex-js-idx-sdk-vars trex_mfa_client_secret MFA_CLIENT_SECRET
  # get_vault_secret_key devex/trex-js-idx-sdk-vars trex_custom_client_id CUSTOM_CLIENT_ID
  # get_vault_secret_key devex/trex-js-idx-sdk-vars trex_custom_client_secret CUSTOM_CLIENT_SECRET
fi
