...
# express-direct-auth-dynamic sample
...
If running from the workspace directory, add the `--cwd` option: `yarn --cwd samples/generated/express-direct-auth-dynamic start`
