...
class EnrollSecurityQuestion extends PageWithTitle {
  ...
  get enrollMethods(): { [key: string]: string } {
      return {
        'Choose a Security Question': this.chooseQuestion,
        'Create my own security question': this.createQuestion,
      };
  }
}

export default new EnrollSecurityQuestion();
